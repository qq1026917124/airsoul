#!/bin/bash
pkill -f "train.py /goosefsx/91mst04h/airs/qxg/czy/airsoul/train_config/02-23-train-rwkv_3b-token_180b-fp32-coninue.yaml" || true
...
./projects/StatefulLM/train.py /goosefsx/91mst04h/airs/qxg/czy/airsoul/train_config/02-23-train-rwkv_3b-token_180b-fp32-coninue.yaml"
