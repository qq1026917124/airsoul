#!/bin/bash
pkill -f "train.py /goosefsx/91mst04h/airs/qxg/czy/airsoul/train_config/02-13-train-rwkv_3b-token_180b-fp32.yaml" || true
...
--master_addr="10.0.0.42" --master_port=29501 \
./projects/StatefulLM/train.py /goosefsx/91mst04h/airs/qxg/czy/airsoul_dev/test.yaml"

# 启动节点
torchrun --nnodes=$nnodes --node_rank=$node_rank --nproc_per_node=8 \
--master_addr="127.0.0.1" --master_port=29501 \
-m  projects.StatefulLM.train /goosefsx/91mst04h/airs/qxg/czy/airsoul_dev/test.yaml
