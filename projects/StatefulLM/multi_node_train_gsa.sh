#!/bin/bash
pkill -f "train.py /goosefsx/91mst04h/airs/qxg/czy/airsoul/train_config/02-15-train-gsa_3b-token_180b-fp32.yaml" || true
...
./projects/StatefulLM/train.py /goosefsx/91mst04h/airs/qxg/czy/airsoul/train_config/02-15-train-gsa_3b-token_180b-fp32.yaml"
