#!/bin/bash
pkill -f "train.py /goosefsx/91mst04h/airs/qxg/czy/airsoul/train_config/02-13-train-rwkv_3b-token_180b-bf16.yaml" || true
...
--master_addr="10.0.0.17" --master_port=29501 \
./projects/StatefulLM/train.py /goosefsx/91mst04h/airs/qxg/czy/airsoul/train_config/02-13-train-rwkv_3b-token_180b-bf16.yaml"
